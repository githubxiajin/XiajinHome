...
import com.xiajin.home.activity.ImageBrowserActivity;
import com.xiajin.home.activity.LocationActivity;
import com.xiajin.home.activity.SetMyInfoActivity;
import com.xiajin.home.adapter.base.BaseListAdapter;
import com.xiajin.home.adapter.base.ViewHolder;
import com.xiajin.home.utils.FaceTextUtils;
import com.xiajin.home.utils.ImageLoadOptions;
import com.xiajin.home.utils.TimeUtil;
...
public class MessageChatAdapter extends BaseListAdapter<BmobMsg> {
	...
	public View bindView(final int position, View convertView, ViewGroup parent) {
		...
		if(avatar!=null && !avatar.equals("")){//加载头像-为了不每次都加载头像
			...
			iv_avatar.setImageResource(R.drawable.touxaingceshi);
		}
