package com.xiajin.home.config;
...
public class BmobConstants {
	 ...
	 * 存放发送图片的目录
	 */
	public static String BMOB_PICTURE_PATH = Environment.getExternalStorageDirectory()	+ "/xiajin/image/";
	
	/**
	 * 我的头像保存目录
	 */
	public static String MyAvatarDir = "/sdcard/xiajin/avatar/";
	/**
	 * 拍照回调
	 */
	...
	public static final int  NETWORKNORMA = 9016; //网络没有连接
