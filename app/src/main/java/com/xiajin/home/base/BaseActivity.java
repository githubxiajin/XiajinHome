...
import com.xiajin.home.controller.NetWorkCenter;
import com.xiajin.home.controller.mInterface.RetryNetwork;
import com.xiajin.home.dialog.DialogTips;
import com.xiajin.home.dialog.LoadingDialog;
import com.xiajin.home.utils.ActivitiesManager;
...
public abstract class BaseActivity extends FragmentActivity implements RetryNetwork  {
...
//				ShowLog("用户位置未发生过变化");
	...
	public void checkLogin() {
		...
		if (userManager.getCurrentUser() == null) {
			/*if ("LoginActivity".endsWith(getRunningActivityName())) {
				return;
			}else {
				toast("您的账号已在其他设备上登录!");
